...
#                     print(Y_train.shape)
                ...
                if val_loss != 'invalid':
                  ...
                  #added by Josh and Shailesh to fix a bug in the code where validation
                  ##set does not exist. This does not fully fix it, as we don't know why the validation
                  #set is not generated. Rather, we just end the training phase here.
                  print('No validation set detected here, moving to testing data')
                  break
...
#             print("logits",logits.shape)
        ...
        if val_prob and val_truth and val_logits:
